...
const TestimonialsSection = () => {
	const testimonials = [
		{
			id: 1,
			text: "Alex transformó nuestra presencia digital y aumentó nuestros ingresos en un 200% en solo cuatro meses. ¡Un trabajo excepcional!",
			author: "Michael Rodriguez",
			position: "Propietario de tienda de E-commerce",
			image: testimonial1,
			rating: 5,
		},
		{
			id: 2,
			text: "Trabajar con Alex fue un cambio radical. La estrategia de contenidos dio resultados más allá de nuestras expectativas.",
			author: "Sarah Chen",
			position: "Directora de Marketing SaaS",
			image: testimonial2,
			rating: 5,
		},
		{
			id: 3,
			text: "Profesional, creativo y orientado a resultados. Alex nos ayudó a alcanzar nuestros objetivos de crecimiento más rápido de lo que pensábamos.",
	...
	return (
		<section id="testimonials" className="dark-section py-20">
			<div className="container mx-auto px-4 lg:px-8">
				...
				<div className="max-w-6xl mx-auto">
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
						...
						<div className="order-1 lg:order-2">
							<h2
								className="section-title text-white mb-8 leading-tight"
								style={{
				...
				{/* Testimonios adicionales (Opcional) */}
